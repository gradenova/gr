...
<head>
    ...
    <title>Smart Grader | Login</title>
        ...
        <div class="col-sm-6">
            ...
            <div class="card-block">
                ...
                <div class="text-center">
                    <button onclick="validate()" class="btn blue darken-4">Login</button>
                    <h5 class="red-text" id="error"></h5>
                </div>
            ...
            <div class="modal-footer">
                <div class="options">
                    <p>Not a member? <a href="../loginvalidate/signup.php">Sign Up</a></p>
                    <p>Forgot <a href="passwordreset.php">Password?</a></p>
                </div>
            </div>
