...
<head>
    ...
    <title>Smart Grader | Create Password</title>
...
$query = mysqli_query($conn,"SELECT email FROM verify WHERE token = '$token' and id = '0'");
        ...
        <div class="col-sm-6">
            ...
            <div class="card-block">
                ...
                <div class="form-header  blue darken-3">
                    <h3><i class="fa fa-lock"></i> &nbsp;Create Password</h3>
                </div>
...
<?php include '../helpers/footer.php'; ?>
                ...
                function updatePassword()
    {
        ...
        if(pwd1 == pwd2 && pwd1 != "")
        {
            ...
            xmlhttp.open("GET","signuptable.php?pwd="+pwd1+"&email="+email,true);
            xmlhttp.send();
        }
        else
        {
            document.getElementById("message").innerHTML = "please check the passwords , those are not identical :)";
