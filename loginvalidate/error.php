...
<head>
    ...
    <title>Smart Grader | Error</title>
    ...
    <div class="row container mx-auto wow" style="margin-top: 10%">
        ...
        <div class="col-sm-6">
            ...
            <div class="card-block">
                ...
                <!--Body-->
                <div class="md-form">
                    <h4 class="text-center blue-text" style="font-size: 20px">The page you are trying to access is not on our Server or the Server may be temporarily unable to process your request.</h4>
