...
<head>
    ...
    <title>Smart Grader | Mail Already exists</title>
        ...
        <div class="col-sm-6">
            ...
            <div class="card-block">
                ...
                <div class="form-header  blue darken-3">
                    <h3><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> &nbsp; Email Exists</h3>
                </div>
                <!-- <form method="POST" action="sendmail.php" onsubmit="return validateForm();"> -->

                <!--Body-->
                <div class="md-form">
                    <h4 class="text-center blue-text" style="font-size: 20px">The requested E-Mail already exists on our server. If you forgot password, please recover you password</h4>
